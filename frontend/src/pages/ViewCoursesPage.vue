<template>
  <q-page class="">
    ...
    <div class="q-mt-md q-px-md" style="background:#EFF8ED;height:90vh">
      ...
      <div class="flex items-center justify-around">
        <div v-for="course in coursesWithSkill" :key="course.id" class="" style="width:350px;background:white;border-radius:5px">
